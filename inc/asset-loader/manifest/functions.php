<?php
/**
 * A copy of https://github.com/humanmade/asset-loader.
 *
 * The namespace has been prefixed to fit this project. Otherwise intentionally verbatim.
 */

namespace Pragmatic\Content_Entity_Fields\Asset_Loader\Manifest;
